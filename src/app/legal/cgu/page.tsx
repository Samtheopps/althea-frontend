        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">4.1 Processus de commande</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-900">4.2 Confirmation de commande</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-900">4.3 Modification ou annulation</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">5.1 Prix</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-900">5.2 Modalités de paiement</h3>
                ...
                <h3 className="text-lg font-medium text-gray-900">5.3 Facturation</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">6.1 Zones de livraison</h3>
                <p className="text-gray-700 leading-relaxed">
                  Les livraisons sont effectuées en France métropolitaine. Pour les DOM-TOM et l'international, 
                  nous consulter.
                </p>

                <h3 className="text-lg font-medium text-gray-900">6.2 Délais de livraison</h3>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <h3 className="text-lg font-medium text-gray-900">6.3 Frais de port</h3>
                <p className="text-gray-700 leading-relaxed">
                  Livraison gratuite à partir de 100€ HT. En deçà, frais de port : 15€ HT.
                </p>

                <h3 className="text-lg font-medium text-gray-900">6.4 Réception</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">7.1 Garantie légale</h3>
                <p className="text-gray-700 leading-relaxed">
                  Tous nos produits bénéficient de la garantie légale de conformité et de la garantie contre les vices cachés.
                </p>

                <h3 className="text-lg font-medium text-gray-900">7.2 Garantie constructeur</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-900">7.3 Exclusions</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">8.1 Droit de rétractation (professionnels)</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-900">8.2 Conditions de retour</h3>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <h3 className="text-lg font-medium text-gray-900">8.3 Frais de retour</h3>
                <p className="text-gray-700 leading-relaxed">
