          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-900">Dénomination sociale</h3>
                  <p className="text-gray-700">Althea Systems SAS</p>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Forme juridique</h3>
                  <p className="text-gray-700">Société par Actions Simplifiée (SAS)</p>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Capital social</h3>
                  <p className="text-gray-700">500 000 €</p>
                </div>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Numéro SIRET</h3>
                  <p className="text-gray-700">123 456 789 00012</p>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Code APE</h3>
                  <p className="text-gray-700">4646Z - Commerce de gros d'équipements et fournitures médicaux</p>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Numéro de TVA intracommunautaire</h3>
                  <p className="text-gray-700">FR 12 123456789</p>
                </div>
              </div>
            </section>
