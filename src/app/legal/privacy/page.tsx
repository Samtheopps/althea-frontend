        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-3">3.1 Données d'identification</h3>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-3">3.2 Données de commande</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-3">3.3 Données de navigation</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4">
                <li>Adresse IP</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">4.1 Gestion des commandes</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">4.2 Gestion de la relation client</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">4.3 Marketing et communication</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">4.4 Amélioration du service</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">4.5 Obligations légales</h3>
                  <p className="text-gray-700">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="font-medium text-gray-900">Prestataires de services</h3>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Transferts d'entreprise</h3>
                  <p className="text-gray-700 text-sm">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-gray-700">Données de compte client</span>
                  <span className="font-medium text-gray-900">3 ans après dernière activité</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-gray-700">Données de commande</span>
                  <span className="font-medium text-gray-900">10 ans (obligation comptable)</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-gray-700">Données de navigation</span>
                  <span className="font-medium text-gray-900">13 mois maximum</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-gray-700">Données marketing</span>
                  <span className="font-medium text-gray-900">3 ans ou jusqu'à désabonnement</span>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Droit à la limitation</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Droit d'opposition</h3>
                  <p className="text-gray-700 text-sm">
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-3">Types de cookies utilisés :</h3>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-900">Délégué à la Protection des Données (DPO)</h3>
                  <p className="text-gray-700 text-sm">
                    Email : dpo@althea-systems.fr<br />
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Autorité de contrôle</h3>
                  <p className="text-gray-700 text-sm">
