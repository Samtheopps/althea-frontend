...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="appearance-none rounded-lg relative block w-full pl-10 pr-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
      ...
      {/* Côté droit - Image/Branding */}
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-8 bg-gradient-to-br from-primary to-secondary">
        <motion.div
        ...
        >
          <h3 className="text-4xl font-heading font-bold mb-6">
            Bienvenue sur Althea Systems
          </h3>
          <p className="text-xl opacity-90 mb-8">
            Votre plateforme de confiance pour tous vos équipements médicaux professionnels
          </p>
          <div className="grid grid-cols-1 gap-6 max-w-md mx-auto">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                <h4 className="font-semibold">Équipements certifiés</h4>
                <p className="text-sm opacity-80">Conformité CE et ISO</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
              ...
              <div className="text-left">
                ...
                <p className="text-sm opacity-80">24-48h partout en France</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
