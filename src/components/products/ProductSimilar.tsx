...
export default function ProductSimilar({ productId, categoryId }: ProductSimilarProps) {
  ...
  useEffect(() => {
    // Vérifier que productId est valide avant de charger les produits similaires
    if (isValidId(productId, 'ProductSimilar useEffect')) {
      loadSimilarProducts();
    } else {
      setLoading(false);
    }
  ...
  const loadSimilarProducts = async () => {
    ...
    if (!isValidId(productId, 'ProductSimilar.loadSimilarProducts')) {
      setLoading(false);
      return;
    }
